...
exercise_list = ['armcurl', 'armraise', 'pushup']
for exercise_element in exercise_list:
    with open(f'preprocess/{exercise_element}.json', 'r+') as f:
        data = json.load(f)
    ...
    with open(f'preprocess/{exercise_element}.json', 'w') as f:
        json.dump(data, f)
    armcurls_f1.clear()
    armcurls_f2.clear()
    armcurls_f3.clear()
